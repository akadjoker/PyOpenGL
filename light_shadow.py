...
while core.run():
    ...
    buffer.begin()
    Render.set_cull_mode(CullMode.Front)
    scene.render_pass(depthShader,False)
    ...
    Render.set_texture(buffer.color,1)
    
    scene.render_pass(shader,True)
    ...
    if showQuad:
        ...
        Render.set_texture(buffer.color, 0)
